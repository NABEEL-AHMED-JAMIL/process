...
public class ExtractionCapTest {
    ...
    @BeforeEach
    void setUp() {
        this.service = new ExtractionServiceImpl(this.storageBrowserService,
    ...
    void theExtractionCeilingSitsAboveEveryProviderPromptBudget() throws Exception {
        Field ceilingField = ExtractionServiceImpl.class.getDeclaredField("MAX_TEXT_CHARS");
