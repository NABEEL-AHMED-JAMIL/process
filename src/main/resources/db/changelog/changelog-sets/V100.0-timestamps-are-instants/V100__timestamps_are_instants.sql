...
-- services now own (V57, V61, V62, V63), Identity's six tables and its signing keys (frozen in etl_job by the
-- MIG-107 cutover and read-only since V69.1; the live tables are identity_db's, whose type identity-service
-- owns), and Liquibase's own two tables.
--
