...
-- No foreign key to public.tenant: workspaces live in identity_db since the MIG-107 cutover, and etl_job's tenant is a
-- frozen copy a new workspace never reaches (V69.1 dropped Core's keys to it for the same reason).
