...
public class StorageBrowserRestApi {
    ...
    // previewTable, previewDocument and previewArchive are Media & Documents' (ADR-012) and live in
    // process.media.api.MediaPreviewRestApi, on the same /storage.json paths.
