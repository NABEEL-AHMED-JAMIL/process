...
public class MessageQRestApi {
    ...
    public ResponseEntity<?> fetchLogs(@RequestBody MessageQSearchRequest messageQSearch) {
        try {
    ...
    public ResponseEntity<?> changeJobStatus(@RequestBody QueueMessageStatusRequest queueMessageStatus) {
        try {
