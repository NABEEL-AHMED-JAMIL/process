...
public class CommonConsumer {
    ...
    public Map<String, Object> fillTaskDetail(JsonObject payload) throws Exception {
        SourceJobQueueDto sourceJobQueueResponse = new Gson().fromJson(payload.get(ProcessUtil.JOB_QUEUE), SourceJobQueueDto.class);
        ...
        taskPayloadInfo.put(ProcessUtil.TASK_DETAIL, new Gson().fromJson(payload.get(ProcessUtil.TASK_DETAIL), SourceJobQueueDto.class));
