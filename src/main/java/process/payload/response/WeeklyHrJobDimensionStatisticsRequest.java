...
public class WeeklyHrJobDimensionStatisticsRequest {
    ...
    public WeeklyHrJobDimensionStatisticsRequest() {}

    public WeeklyHrJobDimensionStatisticsRequest(Long jobId, String jobName,
    ...
    public WeeklyHrJobDimensionStatisticsRequest(Long queue, Long start, Long running, Long failed,
