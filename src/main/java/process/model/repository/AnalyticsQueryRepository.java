 ...
 * */
@Repository
public interface AnalyticsQueryRepository extends JpaRepository<AnalyticsQuery, Long> {
    ...
    List<AnalyticsQuery> findAllByOrderByAnalyticsQueryIdDesc();
     ...
     * only one.
     */
    Optional<AnalyticsQuery> findByAnalyticsQueryId(Long analyticsQueryId);
