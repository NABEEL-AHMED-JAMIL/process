...
import process.model.payload.request.SearchTextRequest;
import process.model.payload.response.QueryResponse;
...
public class QueryService {
    ...
    /**
     * Method use to execute the generic query
     * */
    ...
    public String listSourceTaskQuery(boolean isCount, Long appUserId, String startDate, String endDate, String columnName,
        String order, SearchTextRequest searchTextDto) {
    ...
    public String fetchAllLinkJobsWithSourceTaskQuery(boolean isCount, Long taskDetailId,
        String startDate, String endDate, SearchTextRequest searchTextDto) {
        String selectPortion = "";
        if (isCount) {
            selectPortion = "select count(*) as result ";
        } else {
    ...
    public String fetchJobQLog(MessageQSearchRequest messageQSearch, boolean isState) {
        String selectPortion;
        if (isState) {
