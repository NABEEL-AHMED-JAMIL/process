...
public class ProcessTimeUtil {
    ...
    static {
        // frequency
        frequency.add("Mint"); frequency.add("Hr");
        frequency.add("Daily"); frequency.add("Weekly");
        frequency.add("Monthly");
        // frequency-Detail
        frequencyDetail.put("Mint", getMints()); // int
        frequencyDetail.put("Hr", getHr()); // int
        frequencyDetail.put("Daily", null); // blank
        frequencyDetail.put("Weekly", getWeekly()); // string
        frequencyDetail.put("Monthly", getMonthly()); // int
        // triggerDetail
        triggerDetail.add("process.engine.task.HelloWorldTask");
        triggerDetail.add("process.engine.task.EWalletCardDetailTask");
        triggerDetail.add("process.engine.task.StoreLocatorPinTask");
    }
    ...
    private static List getMonthly() {
        ...
        days.add(16); days.add(17);days.add(18); days.add(19);
        days.add(20); days.add(21);days.add(22); days.add(23);
        days.add(24); days.add(25);days.add(26); days.add(27);
        days.add(28); days.add(29);days.add(30); days.add(31);
        return days;
    }
     ...
     * */
    public static LocalDateTime getRecurrenceTime(LocalDate startDate, String startTime) {
        String timeSplit[] = startTime.split(":");
        return startDate.atStartOfDay().plusHours(Integer.valueOf(timeSplit[0]))
